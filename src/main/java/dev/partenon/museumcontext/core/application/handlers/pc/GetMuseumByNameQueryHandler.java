...
@Service
/**Maneja la Query de PagingMuseumByNameResource*/
public class GetMuseumByNameQueryHandler implements QueryHandler<PagingByNameQuery, PagedResponse<MuseumProjection>> {
    @Autowired
    private MuseumRepository repository;

    @Override
    public PagedResponse<MuseumProjection> handle(PagingByNameQuery query)
            throws Exception {
        //Validacion
